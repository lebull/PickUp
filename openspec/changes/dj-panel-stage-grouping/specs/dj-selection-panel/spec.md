...
**Reason**: Replaced by the stage focus grouping capability (`dj-panel-stage-focus`).
**Migration**: Remove multi-select toggle buttons and `selectedStages` filter logic; replace with focus-stage selector and grouping render described in `dj-panel-stage-focus/spec.md`.
