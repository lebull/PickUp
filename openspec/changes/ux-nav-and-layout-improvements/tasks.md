...
- [ ] 7.2 Manually verify: header shows only trigger button + Import CSV; dropdown reveals Export and prefs controls
- [ ] 7.3 Manually verify: both Submissions and Lineup views are resizable via the divider
- [ ] 7.4 Manually verify: submission count appears in the list controls row
